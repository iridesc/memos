...
interface AuthState {
  ...
  userAutoArchiveSetting: UserSetting_AutoArchiveSetting | undefined;
  shortcuts: Shortcut[];
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const [state, setState] = useState<AuthState>({
    ...
    userAutoArchiveSetting: undefined,
    shortcuts: [],
    isInitialized: false,
    isLoading: true,
  });
  ...
  const fetchUserSettings = useCallback(async (userName: string) => {
    ...
    const autoArchiveSetting = settings.find((s) => s.value.case === "autoArchiveSetting");
    ...
    return {
      ...
      userAutoArchiveSetting: autoArchiveSetting?.value.case === "autoArchiveSetting" ? autoArchiveSetting.value.value : undefined,
      shortcuts,
    };
  }, []);
