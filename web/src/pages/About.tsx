...
const PRODUCT_LINKS = [{ label: "GitHub", href: "https://github.com/iridesc/memos" }];

const PRODUCT_POINTS = ["Self-hosted.", "Markdown + todos.", "Fully yours."];
    ...
    <section className="mx-auto w-full max-w-5xl min-h-full flex flex-col justify-start items-start sm:pt-3 md:pt-6 pb-8">
      <div className="w-full px-4 sm:px-6">
        <div className="w-full rounded-xl border border-border bg-background px-4 py-4 text-muted-foreground">
          <SettingSection
            title="About Memodo"
            description="Open-source, self-hosted note-taking and todo management: Markdown-native, lightweight, and fully yours."
          >
            <SettingGroup>
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <h1 className="text-2xl font-semibold tracking-tight text-foreground">Memodo</h1>
                    <p className="mt-1 text-sm text-muted-foreground">Think it. Note it. Done.</p>
                  </div>
                </div>
