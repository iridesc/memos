...
export type Memo = Message<"memos.api.v1.Memo"> & {
  ...
  /**
   * Optional. The planned start time of the memo.
   * When set, indicates when the user plans to start working on this memo.
   *
   * @generated from field: google.protobuf.Timestamp plan_start_time = 19;
   */
  planStartTime?: Timestamp | undefined;

  /**
   * Optional. The planned end time of the memo.
   * When set, indicates the deadline or planned completion time.
   *
   * @generated from field: google.protobuf.Timestamp plan_end_time = 20;
   */
  planEndTime?: Timestamp | undefined;
};
...
export type ListMemosRequest = Message<"memos.api.v1.ListMemosRequest"> & {
   ...
   * Supported fields: pinned, create_time, update_time, plan_start_time, plan_end_time, name
   *
