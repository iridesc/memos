...
type Memo struct {
	...
	PlanStartTime *timestamppb.Timestamp `protobuf:"bytes,19,opt,name=plan_start_time,json=planStartTime,proto3" json:"plan_start_time,omitempty"`
...
func (x *Memo) GetPlanStartTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Memo) GetPlanEndTime() *timestamppb.Timestamp {
	if x != nil {
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"createTime:X\xeaAU\n" +
	"\x15memos.api.v1/Reaction\x12!memos/{memo}/reactions/{reaction}\x1a\x04name*\treactions2\breaction\"\xcc\t\n" +
	"\x04Memo\x12\x17\n" +
	...
	"\blocation\x18\x12 \x01(\v2\x16.memos.api.v1.LocationB\x03\xe0A\x01H\x01R\blocation\x88\x01\x01\x12G\n" +
	"\x0fplan_start_time\x18\x13 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\rplanStartTime\x12C\n" +
	"\rplan_end_time\x18\x14 \x01(\v2\x1a.google.protobuf.TimestampB\x03\xe0A\x01R\vplanEndTime\x1a\xac\x01\n" +
	"\bProperty\x12\x19\n" +
	...
	"\x14BatchGetLinkMetadata\x12).memos.api.v1.BatchGetLinkMetadataRequest\x1a*.memos.api.v1.BatchGetLinkMetadataResponse\"0\x82\xd3\xe4\x93\x02*:\x01*\"%/api/v1/memos/-/linkMetadata:batchGetB\xa9\x01\n" +
	"\x10com.memos.api.v1B\x10MemoServiceProtoP\x01Z1github.com/usememos/memodo/proto/gen/api/v1;apiv1\xa2\x02\x03MAX\xaa\x02\fMemos.Api.V1\xca\x02\fMemos\\Api\\V1\xe2\x02\x18Memos\\Api\\V1\\GPBMetadata\xea\x02\x0eMemos::Api::V1b\x06proto3"
...
var file_api_v1_memo_service_proto_depIdxs = []int32{
	...
	37, // 10: memos.api.v1.Memo.plan_start_time:type_name -> google.protobuf.Timestamp
	37, // 11: memos.api.v1.Memo.plan_end_time:type_name -> google.protobuf.Timestamp
	...
	40, // 16: memos.api.v1.UpdateMemoRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	30, // 50: memos.api.v1.MemoService.GetMemoByShare:input_type -> memos.api.v1.GetMemoByShareRequest
	...
	41, // 57: memos.api.v1.MemoService.DeleteMemo:output_type -> google.protobuf.Empty
	41, // 58: memos.api.v1.MemoService.SetMemoAttachments:output_type -> google.protobuf.Empty
	13, // 59: memos.api.v1.MemoService.ListMemoAttachments:output_type -> memos.api.v1.ListMemoAttachmentsResponse
	41, // 60: memos.api.v1.MemoService.SetMemoRelations:output_type -> google.protobuf.Empty
	...
	41, // 66: memos.api.v1.MemoService.DeleteMemoReaction:output_type -> google.protobuf.Empty
	...
	41, // 69: memos.api.v1.MemoService.DeleteMemoShare:output_type -> google.protobuf.Empty
